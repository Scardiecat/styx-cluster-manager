...
case class ClusterMemberUniqueAdress(address: ClusterMemberAddress, uid: Int)

case class ClusterMember(uniqueAdress: ClusterMemberUniqueAdress, memberStatus: String, roles: Set[String])
